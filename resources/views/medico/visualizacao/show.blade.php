...
<div class="border-solid border-2 border-width: 2px;">
     ...
     <div class="mx-auto grid grid-cols-2 lg:flex-auto lg:py-20 lg:text-left">
         ...
         <div class="flex flex-col justify-center pl-20">
                ...
                <p class="mt-3 text-lg leading-8 text-black-300">Médico: {{ Str::ucfirst($medico->nome) }}</p>
                <p class="mt-3 text-lg leading-8 text-black-300">CRM: {{ $medico->crm }}</p>
                <p class="mt-3 text-lg leading-8 text-black-300">Especialidade: {{ $medico->especialidade }}</p>
