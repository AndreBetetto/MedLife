    ...
    <body x-cloak x-data="{darkMode: $persist(false)}" :class="{'dark': darkMode === true }" class="bg-purple-50 dark:bg-slate-800 antialiased">
        @include('layouts.header')
            <main class="px-20 py-12 w-full">
                <section class="grid lg:grid-cols-2 items-center py-12 w-full gap-4 md:grid-cols-1 select-none">
                ...
                <section class="flex flex-col justify-center items-center gap-12  py-48 md:grid-cols-1">
                    ...
                    <h3 class="text-3xl dark:text-white">Acesse o Help do sistema <a class="text-indigo-500" href="{{URL::asset('/HelpMedLife.pdf')}}" download="Help do Sistema - MedLife.pdf">aqui</a></h3>
