  ...
  <div class="grid grid-cols-2 gap-4 py-36">
    ...
    <div class="flex flex-col justify-center">
      ...
      <div class="my-5 flex items-center justify-center gap-x-6 lg:justify-start">
        <a href="{{ route('areapaciente.buscar') }}" class="rounded-md bg-purple-300 px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-blue-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue">Médicos disponíveis</a>
