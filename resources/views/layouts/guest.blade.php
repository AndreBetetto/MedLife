...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body x-cloak x-data="{darkMode: $persist(false)}" :class="{'dark': darkMode === true }" class="w-screen bg-gradient-to-r from-violet-500 to-fuchsia-400 h-screen font-sans text-gray-900 antialiased">
