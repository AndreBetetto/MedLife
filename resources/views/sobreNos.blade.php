...
<html lang="en" class="dark">
    ...
    <body class=" bg-purple-50 dark:bg-slate-800">
        ...
        <main class="px-20 pt-24 pb-12">
            <section class="dark:text-slate-100 pb-12 pt-12 flex justify-center items-center flex-col gap-6 text-lg">
                <h1 class="text-4xl">NOSSA EQUIPE</h1>
                ...
                <div class="grid grid-cols-2 w-5/6 gap-5">
